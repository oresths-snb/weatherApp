...
// Βοηθητική κλάση για την διαχείριση και μεταφορά δεδομένων μεταξύ κλάσης client και του βασικού προγράμματος
// Περιέχει boolean τιμές που δηλώνουν την ύπαρξη ακραίων καιρικών φαινομένων
